...
export function ArticleLayout() {
    ...
    function handleSearch(e){
        ...
        nav(`/articles/search/${queryRef.current.value}`)
      }
      ...
      <div className="row mb-5">
        <div className="col-lg-8 col-md-8 col-sm">
            <form className="container input-group" onSubmit={(e) => handleSearch(e)}>
              <input type="search" name="q" id="q" ref={queryRef} placeholder='Search for articles...' className="form-control form-search book-search shadow-sm" />
        ...
        <div className="col-lg-4 col-md-4 col-sm">
          <div className='d-block w-100 m-auto text-center'>
            <Link to="/books/upload" className='text-center m-auto'>
              <button className="btn btn-dark d-inline-block m-auto mt-2">
                Upload An Article
              </button>
            </Link>
          </div>
